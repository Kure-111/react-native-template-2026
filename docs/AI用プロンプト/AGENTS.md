...
- `docs/プロジェクト全体理解.md`: 全体構造と実装の現状を短時間で把握するための要約
- `docs/管理部統合システム理解.md`: 現在注力中の管理部統合システム（item12〜16）の仕様/実装対応メモ
- `docs/Codex編集履歴.md`: AI編集の時系列ログ（次スレッドへ引き継ぐための履歴）

**作業後は `docs/Codex編集履歴.md` に追記してください。**
